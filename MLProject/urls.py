...
urlpatterns = [
    ...
    path('home/Mclassified/results/',views.ResultsPage,name='results'),
    path('home/Mclassified/results2/',views.ResultsPage2,name='results2'),
    path('home/Mclassified/',views.Mclassified,name='Mclassified'),
    path('Bclassified/',views.Bclassified,name='Bclassified'),
